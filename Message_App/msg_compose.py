...
class msgcompose:
    ...
    def sending_msg(self, widget, data):
        ...
        message = {"to_number": "9158077350", "from_number": "9764344549", "type": "text", "priority": "normal", "message": msg}
    ...
    def __init__(self):
        ...
        self.sendto_combo = gtk.ComboBoxEntry()
      ...
      # contact = fr.readline()
      # print contact
      # self.sendto_combo.set_entry_text_column(contact)    
      # fr.close()
